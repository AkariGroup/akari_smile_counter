...
class CalibrationHandler:
    ...
    def getCameraIntrinsics(self, cameraId: CameraBoardSocket, resizeWidth: int = ..., resizeHeight: int = ..., topLeftPixelId: Point2f = ..., bottomRightPixelId: Point2f = ..., keepAspectRatio: bool = ...) -> list[list[float]]:
        ...
        1. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, resizeWidth: int = -1, resizeHeight: int = -1, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x7f5f7e4db870>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x7f5f7e555870>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        2. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: depthai.Size2f, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x7f5f8af13370>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x7f5f7e531e70>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        3. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: tuple[int, int], topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x7f5f7e5759f0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x7f5f7e52cff0>, keepAspectRatio: bool = True) -> list[list[float]]
